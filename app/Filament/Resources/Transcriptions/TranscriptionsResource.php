...
use App\Filament\Resources\Transcriptions\Pages\ViewTranscriptions;
use App\Filament\Resources\Transcriptions\Schemas\TranscriptionsForm;
use App\Filament\Resources\Transcriptions\Schemas\TranscriptionsInfolist;
...
class TranscriptionsResource extends Resource
{
    ...
    {
        return TranscriptionsInfolist::configure($schema);
    }
